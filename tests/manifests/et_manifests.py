...
def run_me():
    ...
    def create_delete_svc(name, svc_id, plan_id):
    ...
    if register_service:
        ...
        if create_services:
            ...
            if len(response.json()) > 0:
                print("Not all instances have been deleted!")
